...
int main(int argc, char ** argv) {
        ...
        /*   std::vector<std::vector<float> > bin_gear = {{-0.37,-1.13,0.74},{-0.37,-1.26,0.74},{-0.37,-1.4,0.74},{-0.23,-1.26,0.74},{-0.5,-1.53,0.74},{-0.5,-1.26,0.74},{-0.5,-1.13,0.74}};
           std::vector<std::vector<float> > bin_rod  = {{-0.4,-0.635,0.74},{-0.2,-0.435,0.74},{-0.2,-0.635,0.74},{-0.4,-0.435,0.74}};
           std::vector<std::vector<float> > bin_gasket = {{-0.4,0.13,0.75},{-0.4,0.33,0.75},{-0.4,0.13,0.75},{-0.2,0.33,0.75}};
